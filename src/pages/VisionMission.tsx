    ...
    <div className="section-container mt-12 sm:mt-16">
      <div className="grid gap-8 lg:grid-cols-2">
        <article className="group relative overflow-hidden rounded-2xl border border-blue-100 bg-white p-8 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-xl sm:p-10">
          ...
          <h2 className="mb-5 text-3xl font-bold text-jci-blue">JCI Vision</h2>
          <blockquote className="border-l-4 border-jci-gold pl-5 text-xl leading-relaxed text-slate-600 sm:text-2xl">&quot;To be the leading global network of young active citizens.&quot;</blockquote>
        </article>
        <article className="group relative overflow-hidden rounded-2xl border border-blue-100 bg-white p-8 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-xl sm:p-10">
          ...
          <h2 className="mb-5 text-3xl font-bold text-jci-blue">JCI Mission</h2>
          <blockquote className="border-l-4 border-jci-gold pl-5 text-xl leading-relaxed text-slate-600 sm:text-2xl">&quot;To provide leadership development opportunities that empower young people to create positive change.&quot;</blockquote>
        </article>
      </div>
      <section className="mt-8 overflow-hidden rounded-2xl bg-jci-blue px-8 py-12 text-center text-white shadow-xl sm:px-12 sm:py-16">
        <div className="mx-auto flex max-w-3xl flex-col items-center"><div className="mb-5 flex h-12 w-12 items-center justify-center rounded-full bg-white/10 text-jci-gold"><Sparkles size={24} /></div><p className="mb-3 text-sm font-bold uppercase tracking-[0.2em] text-blue-100">Our Theme</p><h2 className="text-3xl font-extrabold tracking-[0.08em] text-white sm:text-5xl">AIM <span className="text-jci-gold">&bull;</span> GROW <span className="text-jci-gold">&bull;</span> IMPROVE</h2></div>
      </section>
    </div>
  </div>
);
